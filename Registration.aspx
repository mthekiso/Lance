<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="LanceWebApplication.Registration" %>
<asp:Content ID="Head" ContentPlaceHolderID="Head" runat="server">

</asp:Content>
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <p class="cta" style="height: 1px"></p>
    <form runat="server">
            ...
            <div class="container">
                ...
                <asp:TextBox required="required" ID="txtUsername" runat="server" Height="43px" Width="404px" OnTextChanged="txtUsername_TextChanged"></asp:TextBox>
                <asp:Label ID="lblUsnamecheck" runat="server"></asp:Label>
                <br /><br />

                <asp:Label ID="email" runat="server" Text="Email address"></asp:Label><br />
                <asp:TextBox ID="txtEmail" TextMode="Email" runat="server" Height="43px" Width="404px" OnTextChanged="txtEmail_TextChanged"></asp:TextBox>
                <asp:Label ID="lblEmcheck" runat="server"></asp:Label>
                <br /><br />
